...
class EaqoonsiIconButton extends StatefulWidget {
  const EaqoonsiIconButton({
    super.key,
    required this.icon,
    this.borderColor,
    this.borderRadius,
  ...
  @override
  State<EaqoonsiIconButton> createState() => _EaqoonsiIconButtonState();
}

class _EaqoonsiIconButtonState extends State<EaqoonsiIconButton> {
  bool loading = false;
  ...
  @override
  void didUpdateWidget(EaqoonsiIconButton oldWidget) {
