...
class EaqoonsiButtonOptions {
  const EaqoonsiButtonOptions({
    this.textStyle,
    this.elevation,
    this.height,
    this.width,
...
class EaqoonsiButtonWidget extends StatefulWidget {
  const EaqoonsiButtonWidget({
    super.key,
    required this.text,
  ...
  final EaqoonsiButtonOptions options;
  final bool showLoadingIndicator;

  @override
  State<EaqoonsiButtonWidget> createState() => _EaqoonsiButtonWidgetState();
}

class _EaqoonsiButtonWidgetState extends State<EaqoonsiButtonWidget> {
  bool loading = false;
